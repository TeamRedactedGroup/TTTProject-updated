...
public class UserInterface : MonoBehaviour 
{
	...
	void newPlayer1Menu()
	{
		...
		GUI.Label (new Rect (screenWidth * 0.4f, screenHeight * 0.135f, buttonWidth * 0.5f, buttonHeight * 0.5f), "Enter P1 Name:");
	...
	void newPlayer2Menu()
	{
		...
		// Make standard text saying enter name
		GUI.Label (new Rect (screenWidth * 0.4f, screenHeight * 0.135f, buttonWidth * 0.5f, buttonHeight * 0.5f), "Enter P2 Name:");
