...
public class AIHardClass : AIMediumClass
{
	...
	public override bool GetMove()
	{
		...
		if (boardLocation == nullVector && boardLocation2 == nullVector && boardLocation3 == nullVector && boardLocation4 == nullVector && boardLocation5 == nullVector && boardLocation6 == nullVector && boardLocation7 == nullVector) {
			do {
								tempX = ran.Next (5);
								tempY = 0.1f;
								tempZ = ran.Next (5);
