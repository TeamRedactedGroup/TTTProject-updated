...
public class BoardArray : MonoBehaviour {
	...
	#region Variables
	// Keeps track of which win conditions apply to which coordinates
	public static bool[, ,] winCheckBoard = new bool[5, 5, 28];
	// Keeps track of each player's win conditions
	public static int[] winCheckSumX = new int[28]; 
	public static int[] winCheckSumO = new int[28];
